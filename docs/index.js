        ...
        function addPageBottom(hook, vm) {
            hook.afterEach((html) => {
                ...
                const localizedPageBottoms = {
                    'zh-cn': '<div align="center">2021-2023 由 <a href="https://ve">维尼·弗兰</a> 和引擎部落团队用 💗 创作</div>',
                    'es-es': '<div align="center">2021-2023 Por <a href="https://ve">VeneFran</a> y el equipo de Engine Tribe con 💗</div>'
                }
